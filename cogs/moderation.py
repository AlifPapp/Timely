...
class moderation(commands.Cog):
    ...
    async def giveadmin(self, ctx, user: discord.Member = None):
        ...
        if ctx.author.guild_permissions.administrator:
            guild = ctx.guild
            if user is None:
                em = discord.Embed(description = f"{ctx.author.mention} give admin to who?",
            ...
            em = discord.Embed(description = f"{user.mention} received the role {role.mention}",
                               color = self.client.Red,
                               timestamp=datetime.utcnow())
            await ctx.send(embed = em)
        else:
            em = discord.Embed(description = f"{ctx.author.mention} you don't have permission `administrator` to do that!",
                               color = self.client.Red,
                               timestamp=datetime.utcnow())
            await ctx.reply(embed = em)
    ...
    async def purge(self, ctx, amt: int = 50):
        ...
        if ctx.author.guild_permissions.manage_messages:
            ...
            em = discord.Embed(description = f"{ctx.author.mention} you don't have the permission `manage_messages` to do that!",
                               color = self.client.Red,
                               timestamp=datetime.utcnow())
            await ctx.reply(embed = em)
    ...
    async def ban(self, ctx, user: discord.Member = None, reason: str=None, delete_message_days: int=0):
        ...
        if ctx.author.guild_permissions.ban_members:
            if user is None:
                em = discord.Embed(description = "Who do i ban? you?",
                                   color = self.client.Red,
                                   timestamp=datetime.utcnow())
                await ctx.reply(embed = em)
                return
            ...
            try:
                ...
                em = discord.Embed(description = f"I need the permissions to do this",
                                   color = self.client.Red,
                                   timestamp=datetime.utcnow())
            ...
            em = discord.Embed(description = "You don't have the permission `ban_members` to do that!",
                               color = self.client.Red,
                               timestamp=datetime.utcnow())
    ...
    async def unban(self, ctx, userid: int=0):
        if ctx.guild is None:
            return
        if userid == 0:
            em = discord.Embed(description = "I need a user id",
                               color = self.client.Red,
                               timestamp=datetime.utcnow())
        ...
        try:
            ...
            em = discord.Embed(description = "Invalid id, user not found.",
                               color = self.client.Red,
                               timestamp=datetime.utcnow())
            ...
            em = discord.Embed(description = "Fetching the user failed.",
                               color = self.client.Red,
                               timestamp=datetime.utcnow())
        ...
        if Check == True:
            ...
            em = discord.Embed(description = f"{user.name} has been unbaned from {targetguild.name}.",
                               color = self.client.Red,
                               timestamp=datetime.utcnow())

            await ctx.reply(embed = em)
        else:
            em = discord.Embed(description = f"{userid} is not found as banned users from {targetguild.name}.",
                               color = self.client.Red,
                               timestamp=datetime.utcnow())
