...
class help(commands.Cog):
    ...
    async def help(self, ctx):
        ...
        em.add_field(name="🍑 NSFW",value = f"`{p}help nsfw`",inline=True)
    ...
    async def nsfw(self, ctx):
        ...
        commands_list = sorted(["ass","cosplaygirls","hentai","nsfw","sexy","sexy_asians","tattooed_redheads","tattooedgirls","twerking"])
        commands_list = f"`, `{p}".join(commands_list)
        commands_list = f"`{p}{commands_list}`"

        em = discord.Embed(title = "🍑 NSFW commands",
                           description = commands_list,
                           colour = self.client.Green,
                           timestamp=datetime.utcnow())
...
#####################################################################################################################################
    ...
    async def ass(self, ctx):
        p = self.client.serverprefix
        em = discord.Embed(title = "Ass",
                           description = "Returns submissions from r/ass",
                           colour = self.client.Green,
                           timestamp=datetime.utcnow())

        em.add_field(name="**Syntax**",value=f"`{p}ass`")
        em.add_field(name="**Values**",value=f"Cooldown: 3 Secconds",inline = False)
    ...
    async def cosplaygirls(self, ctx):
        p = self.client.serverprefix
        em = discord.Embed(title = "Cosplay Girls",
                           description = "Returns submissions from r/cosplaygirls",
                           colour = self.client.Green,
                           timestamp=datetime.utcnow())

        em.add_field(name="**Syntax**",value=f"`{p}cosplaygirls`")
        em.add_field(name="**Values**",value=f"Cooldown: 3 Secconds",inline = False)
    ...
    async def hentai(self, ctx):
        p = self.client.serverprefix
        em = discord.Embed(title = "Hentai",
                           description = "Returns submissions from r/hentai",
                           colour = self.client.Green,
                           timestamp=datetime.utcnow())

        em.add_field(name="**Syntax**",value=f"`{p}hentai`")
        em.add_field(name="**Values**",value=f"Cooldown: 3 Secconds",inline = False)
    ...
    async def sexy(self, ctx):
        p = self.client.serverprefix
        em = discord.Embed(title = "Sexy",
                           description = "Returns submissions from r/Sexy",
                           colour = self.client.Green,
                           timestamp=datetime.utcnow())

        em.add_field(name="**Syntax**",value=f"`{p}Sexy`")
        em.add_field(name="**Values**",value=f"Cooldown: 3 Secconds",inline = False)
    ...
    async def sexy_asians(self, ctx):
        p = self.client.serverprefix
        em = discord.Embed(title = "Sexy Asians",
                           description = "Returns submissions from r/Sexy_Asians",
                           colour = self.client.Green,
                           timestamp=datetime.utcnow())

        em.add_field(name="**Syntax**",value=f"`{p}sexy_asians`")
        em.add_field(name="**Values**",value=f"Cooldown: 3 Secconds",inline = False)
        
        await ctx.send(embed = em)
    
    # thelp tattooed_redheads
    @help.command()
    async def tattooed_redheads(self, ctx):
        p = self.client.serverprefix
        em = discord.Embed(title = "Tattooed Redheads",
                           description = "Returns submissions from r/tattooed_redheads",
                           colour = self.client.Green,
                           timestamp=datetime.utcnow())

        em.add_field(name="**Syntax**",value=f"`{p}tattooed_redheads`")
        em.add_field(name="**Values**",value=f"Cooldown: 3 Secconds",inline = False)
    ...
    async def tattooedgirls(self, ctx):
        p = self.client.serverprefix
        em = discord.Embed(title = "Tattooed Girls",
                           description = "Returns submissions from r/tattooedgirls",
                           colour = self.client.Green,
                           timestamp=datetime.utcnow())

        em.add_field(name="**Syntax**",value=f"`{p}tattooedgirls`")
        em.add_field(name="**Values**",value=f"Cooldown: 3 Secconds",inline = False)
    ...
    async def twerking(self, ctx):
        p = self.client.serverprefix
        em = discord.Embed(title = "Twerking",
                           description = "Returns submissions from r/twerking",
                           colour = self.client.Green,
                           timestamp=datetime.utcnow())

        em.add_field(name="**Syntax**",value=f"`{p}twerking`")
        em.add_field(name="**Values**",value=f"Cooldown: 3 Secconds",inline = False)
