...
class help(commands.Cog):
    ...
    async def currency(self, ctx):
        ...
        em.add_field(name="Commands:",value=f"`{p}balance`, `{p}profile`, `{p}rich`, `{p}pray`, `{p}work`, `{p}steal`, `{p}give`")
    ...
    async def information(self, ctx):
        ...
        em.add_field(name="Commands:",value=f"`{p}prefix`, `{p}ping`, `{p}invite`, `{p}creator`, `{p}userinfo`, `{p}serverinfo`, `{p}botinfo`, `{p}oldest`, `{p}youngest`")
...
#####################################################################################################################################
    ...
    async def give(self, ctx):
        ...
        em = discord.Embed(title = "Give",
                           ...
                           colour = self.client.Green,
                           timestamp=datetime.utcnow())
        em.add_field(name="**Syntax**",value=f"`{p}give <user> <ammount>`")
...
#####################################################################################################################################
    ...
    async def youngest(self, ctx):
        p = self.client.serverprefix
        em = discord.Embed(title = "Youngest",
                           description = "Returns the youngest accounts in the server.",
                           colour = self.client.Green,
                           timestamp=datetime.utcnow())
        em.add_field(name="**Syntax**",value=f"`{p}youngest`")
