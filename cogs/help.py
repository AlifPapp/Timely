...
#####################################################################################################################################
    ...
    async def play(self, ctx):
        ...
        em.add_field(name="**Aliases**",value=f"`{p}play`, `{p}p`")
...
#####################################################################################################################################
    ...
    async def redditsearch(self, ctx):
        ...
        em.add_field(name="**Syntax**",value=f"`{p}redditsearch r/`")

        await ctx.send(embed = em)
    
    # thelp redditabout
    @help.command()
    async def redditabout(self, ctx):
        p = self.client.serverprefix
        em = discord.Embed(title = "redditabout",
                           description = "Returns information about a subreddit",
                           colour = self.client.Green,
                           timestamp=datetime.utcnow())

        em.add_field(name="**Syntax**",value=f"`{p}redditabout r/`")
