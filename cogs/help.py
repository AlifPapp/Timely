...
class help(commands.Cog):
    ...
    async def help(self, ctx):
        ...
        em.add_field(name="Currency",value=f"`{p}‏‎help currency`")
        em.add_field(name="Music",value=f"`{p}‏‎help music`")
        em.add_field(name="Moderation",value=f"`{p}‏‏‎‏help moderation‏‎`")
        em.add_field(name="Config",value=f"`{p}‏‏‎‏‏‎help config‏‎`")
        em.add_field(name="Other",value=f"‏‏‎‏‏‎`{p}help other`")
    ...
    async def currency(self, ctx):
        ...
        em.add_field(name="Commands:",value=f"{p}balance, {p}profile, {p}pray, {p}work, {p}steal")
    ...
    async def other(self, ctx):
        ...
        em = discord.Embed(title = "Other commands",
                           description = "Every other command that didn't sit in a specific category.",
                           colour = self.client.Green,
                           timestamp=datetime.utcnow())

        em.add_field(name="Commands:",value=f"{p}invite, {p}upvote, {p}prefix, {p}ping, {p}userinfo, {p}serverinfo, {p}zseni")
...
#####################################################################################################################################
    ...
    async def upvote(self, ctx):
        ...
        em = discord.Embed(title = "Upvote TimelyBot",
                           ...
                           colour = self.client.Green,
                           timestamp=datetime.utcnow())
        em.add_field(name="**Syntax**",value=f"upvote")
    ...
    async def serverinfo(self, ctx):
        ...
        em.add_field(name="**Syntax**",value="serverinfo <usrs>")
