...
class help(commands.Cog):
    ...
    async def currency(self, ctx):
        ...
        em.add_field(name="Commands:",value=f"`{p}balance`, `{p}profile`, `{p}rich`, `{p}globalrich`, `{p}pray`, `{p}daily`, `{p}weekly`, `{p}monthly` `{p}work`, `{p}steal`, `{p}give`, '{p}gamble`")
...
#####################################################################################################################################
    ...
    async def gamble(self, ctx):
        ...
        em = discord.Embed(title = "Gamble",
                           ...
                           colour = self.client.Green,
                           timestamp=datetime.utcnow())
        em.add_field(name="**Syntax**",value=f"`{p}gamble <user> <ammount>`")
        em.add_field(name="**Aliases**",value=f"`{p}gamble`, `{p}bet`")
