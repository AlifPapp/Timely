...
############################################################# VARIABLES #############################################################
#####################################################################################################################################
with open("count_emoji.json","r") as f: 
...
client.reddit = asyncpraw.Reddit(client_id=client.Secrets["Reddit_client_id"],
                client_secret=client.Secrets["Reddit_client_secret"],
                user_agent='phyton_praw')

client.mongodb = MongoClient(client.Secrets["MongoClientLink"], ssl_cert_reqs=ssl.CERT_NONE)
#####################################################################################################################################
############################################################## C O G S ##############################################################
#####################################################################################################################################
...
async def on_guild_join(guild):
    ...
    #Send message in TimelyBot Official
