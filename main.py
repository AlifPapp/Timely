import discord
from discord import embeds, user, member, client
from discord.colour import Color
from discord.ext import commands, tasks
from discord.ext.commands import bot, when_mentioned_or, CommandNotFound
from discord.ext.commands.bot import Bot
from discord.ext.commands.core import guild_only
from discord.ext.commands.errors import ChannelNotFound, MissingPermissions, MissingRequiredArgument, MissingRole
...
MongoClientLink = str(os.environ.get('MONGO_LINK'))
